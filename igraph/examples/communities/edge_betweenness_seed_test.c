...
//                 -1);
//
//    igraph_community_edge_betweenness_seed(&g, 0, 0, 0, 0, &modularity, &membership, IGRAPH_UNDIRECTED, 0, &seed_membership);
//
...
//
    ...
    VECTOR(seed_membership)[0] = 0;
    VECTOR(seed_membership)[1] = 0;
